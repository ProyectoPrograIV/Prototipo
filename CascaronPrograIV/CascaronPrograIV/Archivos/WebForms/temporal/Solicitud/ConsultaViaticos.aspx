...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView CssClass="DataGrid" ID="Gv_ConsultaSolicitud" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" HeaderStyle-Height="50px">
